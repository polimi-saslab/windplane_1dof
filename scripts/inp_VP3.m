function par = inp_VP3(par)

%% atmospheric values
vw_range = (2:0.5:15)';  % [m/s] wind speed range
h_ref    = 30;            % [m]   reference altitude (hub height of VP3)
...
par.L_te = 70;  % [m] tether length
par.D_te = 5 * 1e-3; % [m] external tether diameter
